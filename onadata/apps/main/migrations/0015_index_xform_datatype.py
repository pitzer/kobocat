...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MetaData', fields ['xform', 'data_type']
        db.create_index(u'main_metadata', ['xform_id', 'data_type'])


    def backwards(self, orm):
        # Removing index on 'MetaData', fields ['xform', 'data_type']
        db.delete_index(u'main_metadata', ['xform_id', 'data_type'])
    ...
    models = {
        ...
        'main.metadata': {
            'Meta': {'unique_together': "(('xform', 'data_type', 'data_value'),)", 'object_name': 'MetaData', 'index_together': "(('xform', 'data_type'),)"},
