...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Export', fields ['xform', 'export_type']
        db.create_index(u'viewer_export', ['xform_id', 'export_type'])


    def backwards(self, orm):
        # Removing index on 'Export', fields ['xform', 'export_type']
        db.delete_index(u'viewer_export', ['xform_id', 'export_type'])
    ...
    models = {
        ...
        'viewer.export': {
            'Meta': {'unique_together': "(('xform', 'filename'),)", 'object_name': 'Export', 'index_together': "(('xform', 'export_type'),)"},
